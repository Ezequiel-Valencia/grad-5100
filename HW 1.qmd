...
(iiii). The sampling for mean seems to be similar in accuracy for both groups, however, the higher sampling groups variance is less accurate then the lower sampled variance.
...
b.  To reach the top 5% in store revenue you need 711.22.
